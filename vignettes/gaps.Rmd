...
```{r out.width='90%', fig.showtext=TRUE}
...
```{r, fig.showtext=TRUE, out.width="90%", fig.cap="Probability that an animal leaves the field-of-view, based on clear evidence from the images, for gaps between images of 20-120 seconds."}
...
<center>
Next: [Deployment timeframes](link) <br>
Previous: [Overview](link)
</center>
