...
wmu_sample_deployments <- get_cam(wmu_sample, cols = "WMUNIT_NAM", keep.all = FALSE)
...
# Join density
df_density <- join_dens(wmu_sample_deployments, species = c("Moose", "Mule deer"), nest = FALSE)
...
df_density_summary <- summarise_dens(df_density, group = WMUNIT_NAM, agg.years = FALSE, conflevel = 0.9)
